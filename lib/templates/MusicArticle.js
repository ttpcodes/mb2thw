  ...
  async otherArtists(recur) {
    ...
    if (await this.parser.get(this.parser.types.BOOLEAN, {
      ...
      otherArtists += (recur ? '' : `| other_staff =\n`) +
        ...
        artists.map(function(artist) {
          return `: ${artist}\n`;
        }).join('') + await this.otherArtists(true);
    }
    return otherArtists;
  }
        ...
        if (await this.parser.get(this.parser.types.BOOLEAN, {
          ...
          while (getTracks) {
            if (await this.parser.get(this.parser.types.BOOLEAN, {
              ...
              works += `** original title: ${await this.parser.get(this.parser.types.STRING, {
          ...
          works += `** source: ${await this.parser.get(this.parser.types.STRING, {
