...
class MusicArticle {
  ...
  async parse() {
    return `{{MusicArticle\n` +
      ...
      await artists('arranger', this.parse, true) +
      await artists('lyricist', this.parser, true) +
      await artists('vocalist', this.parser, true) +
      await artists('producer', this.parser, true) +
      await artists('illustrator', this.parser, true) +
      await artists('designer', this.parser, true) +
      await artists('masterer', this.parser, true) +
